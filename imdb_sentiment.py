...
app.flags.DEFINE_integer("d_model", 64, "encoder model size")
app.flags.DEFINE_integer("d_ff", 256, "feedforward model size")
app.flags.DEFINE_integer("num_heads", 8, "number of attention heads")
app.flags.DEFINE_float("dropout", 0.25, "dropout")
